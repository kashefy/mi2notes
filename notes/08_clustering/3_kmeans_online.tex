...
\includegraphics[height=3cm]{img/section4_fig4} 
  \notesonly{\caption{Decaying learning rate schedule to satisfy Robbins-Monro conditions.}}
...
\notesonly{\captionof{figure}Example of K-means finding a solution that is a local minumum. Each plot is a snapshot of the prototypes at some iteration of the algorithm.}
\end{center}
