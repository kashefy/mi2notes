...
\only<1>{
\slidesonly{
	\includegraphics[trim=950 0 0 0,clip, width=0.6\textwidth]{img/sin_clustering}
	}
	}
\only<2>{
...
\begin{frame}{A ``sorted'' K-means to reflect topology}
...
\begin{center}
	...
	\captionof{figure}{Equivalent clustering solution with 7 prototypes that reflects some topology in the data.}
\end{center}
...
\begin{frame}{Motiation for clustering that preserves neighborhood}
...
\begin{center}
	...
	\captionof{figure}{To the little ant sinusoid is just a 1D line. No turns, no elevation.}
\end{center}
