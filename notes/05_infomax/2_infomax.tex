...
\underline{Recap on Density Transformation}:
...
\question{What is density transformation for? }
...
\begin{equation}
  \label{eq:dtufs}
		...
		\widehat{P}_{s_i}(\widehat{s}_i) \; \stackrel{!}{=} \; \text{const} \qquad \Rightarrow \qquad 
...
\question{why didn't we use the Inverse CDF technque?}
...
Maximizing $I(Y,X)$ boils down to maximizing the entropy of the output $Y$. 
