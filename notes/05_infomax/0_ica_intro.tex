...
\question{Are $x$ and $y$ are uncorrelated?}
...
\slidesonly{
\begin{center}
\includegraphics[width=0.4\textwidth]{img/meme_yesuncorrelated}
\end{center}
}
...
\question{Are $x$ and $y$ are statistically independent?}

\pause

\notesonly{On the other hand, if }we calculate $\E  \lbrack \, g(x) h(y) \, \rbrack$ with $g(x)=x^2$ and $g(y)=y^2$:\\
